...
import com.garam.mydream.getPlatform
...
@Composable
fun LoginBottomSheetScreen(onDismiss: () -> Unit, onSuccessLogin : () -> Unit ,loginViewModel: LoginViewModel = koinViewModel()) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            SocialLoginBtn(onClick = {}, btnText = stringResource(Res.string.login_bottom_sheet_google_login_btn_text)
                , icon = Res.drawable.google_login_icon, textColor = Color.Black, btnBgColor = Color.White)

            Spacer(modifier = Modifier.height(24.dp))

            if(getPlatform().name == "iOS") SocialLoginBtn(onClick = {
